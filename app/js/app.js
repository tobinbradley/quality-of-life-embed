...
// set embed source
document.querySelector('#mapembed').value = `<iframe src="https://mcmap.org/qol-embed/embed.html?m=${m}&y=${y}&s=${s.join(',')}&t=${encodeURI(t)}&tocp=true&pitch=false" style="width: 500px; height: 500px; border: 1px solid #ccc;" title="map"></iframe>`; 
...
window.titleChange = function (title) {
    ...
    document.querySelector('#mapembed').value = `<iframe src="https://mcmap.org/embed.html?m=${m}&y=${y}&s=${s.join(',')}&t=${encodeURI(title)}&tocp=true&pitch=false" style="width: 500px; height: 500px; border: 1px solid #ccc;" title="map"></iframe>`; 
};
